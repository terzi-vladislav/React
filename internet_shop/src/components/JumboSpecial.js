...
import backgroundSpecial from "../assets/special.jpg";

const Styles = styled.div`
    .jumbo {
        background: url(${backgroundSpecial}) no-repeat fixed bottom;
    ...
    <Styles>
        <div className="shop">
            ...
            <div className="header-div">
                <h1 className="header">What can be better than a unique toy?</h1>
            </div>
            <Nav.Link href="#special" className="down">
